    ...
    <>
      ...
      <section className="relative h-[50vh] sm:h-[60vh] overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
          ...
          >
            {aboutContent.title}{" "}
            <span className="italic text-gold">{aboutContent.titleAccent}</span>
          </motion.h1>
          <motion.div
            initial={{ scaleX: 0 }}
            animate={{ scaleX: 1 }}
            ...
            <SlideIn direction="left">
              <div>
                ...
                <h2 className="heading-md sm:heading-lg text-charcoal mb-6 font-heading">
                  {aboutContent.title}{" "}
                  <span className="text-emerald italic">{aboutContent.titleAccent}</span>
                </h2>
                ...
                <p className="body-md text-text-muted-custom mb-8">
                  {aboutContent.descriptionSecondary}
                </p>
                <Button
                  asChild
                  variant="outline"
        ...
        <div className="mx-auto max-w-7xl">
              ...
              <Card className="bg-white hover:shadow-xl transition-all duration-300 h-full border-t-4 border-t-emerald">
                <CardContent className="p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="heading-sm text-charcoal">{aboutContent.mission.title}</h3>
                  </div>
              ...
              <Card className="bg-white hover:shadow-xl transition-all duration-300 h-full border-t-4 border-t-gold">
                <CardContent className="p-6 sm:p-8">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="heading-sm text-charcoal">{aboutContent.vision.title}</h3>
                  </div>
                  <p className="body-md text-text-muted-custom leading-relaxed">
          ...
          <FadeInUp>
            <div className="text-center mb-10">
              <h3 className="heading-sm text-charcoal">Indangagaciro Zacu</h3>
            </div>
          </FadeInUp>
          ...
          <FadeInUp>
            <div className="text-center max-w-3xl">
              ...
              <h2 className="text-2xl sm:heading-lg text-white mb-6 font-heading font-bold">
                Ushaka <span className="italic text-gold-light">Kumenya Byinshi?</span>
              </h2>
              <p className="body-md sm:body-lg text-white/70 mb-8">
                Twandikire kandi tuzagusubiza vuba.
              </p>
              <Button
                asChild
