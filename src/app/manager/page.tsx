              ...
              <CardContent className="space-y-3">
                {branchOrders.filter((o) => o.status !== "served").slice(0, 4).map((order) => (
                  <div key={order.id} className="flex items-center justify-between p-3 rounded-lg bg-pearl/50">
                    <div className="flex items-center gap-3">
                      <div className={`h-2 w-2 rounded-full ${order.status === "pending" ? "bg-orange-500" :
                    ...
                    <div className="text-right">
                      <Badge className={`text-[10px] ${order.status === "pending" ? "bg-orange-100 text-orange-700" :
              ...
              <CardContent className="space-y-3">
                {serviceRequests.filter((sr) => sr.status !== "completed").slice(0, 4).map((sr) => (
                  <div key={sr.id} className="flex items-center justify-between p-3 rounded-lg bg-pearl/50">
                    <div className="flex items-center gap-3">
                      <div className={`h-2 w-2 rounded-full ${sr.priority === "urgent" ? "bg-red-500" :
                    ...
                    <Badge
                      variant="outline"
                      className={`text-[10px] ${sr.priority === "urgent" ? "border-red-300 text-red-700" :
